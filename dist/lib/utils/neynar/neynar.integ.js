...
const neynarUserFunctions_1 = require("./user/neynarUserFunctions");
const neynarFrameFunctions_1 = require("./frame/neynarFrameFunctions");
describe('neynar integration tests', () => {
    it('bulk data lookup should find all users', async () => {
        ...
        const response = await (0, neynarUserFunctions_1.neynarBulkUserLookup)(fidsToLookup);
    ...
    it('frame validation returns correct data', async () => {
        const messageBytes = '0a4f080d10d7ef0b18aec6a62e200182013f0a1f68747470733a2f2f6672616d652d64656d6f2e76657263656c2e6170702f321001' +
        ...
        const response = await (0, neynarFrameFunctions_1.neynarFrameValidation)(messageBytes);
